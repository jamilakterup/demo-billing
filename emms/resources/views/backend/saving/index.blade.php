                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a  href="{{route('savings.create')}}" title="add new member" class="btn-sm btn-primary" data-card-widge="collapse">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($savings as $saving)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('savings.edit',$saving->id)}}" title="edit" class="btn-sm btn-success "><i class="fas fa-edit"></i></a>
