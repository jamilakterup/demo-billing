                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{Form::open(['route'=>'profileLoan.store','class'=>'form','files'=>true])}}

                                    <div class="form-group col-sm-6 offset-3">
                                        <div class="row">
                                            <label class="col-sm-4 col-form-label">Member</label>
                                            <div class="col-sm-8">
                                                {{Form::hidden('user_id',$member->user_id,['class'=>'form-control','readonly'=>true])}}
                                                {{Form::hidden('member_id',$member->id,['class'=>'form-control','readonly'=>true])}}
                                                {{Form::text('member_name',$member->name,['class'=>'form-control','readonly'=>true])}}
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#principal").keyup(function (){
                    ...
                    var ten_percent= (principal*10)/100;

                    $('#savings').val(ten_percent);
