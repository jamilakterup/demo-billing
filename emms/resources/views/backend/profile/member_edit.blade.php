                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{Form::model($member,['route'=>['profile.member.update',$member->id],'class'=>'form','files'=>true,'method'=>'put'])}}
                            <fieldset class="border p-4 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {{Form::hidden('user_id',$member->user_id,['class'=>'form-control'])}}
                                        {{Form::text('user_name',$member->userName->name,['class'=>'form-control','readonly'=>'true'])}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                {{Form::text('dob',null,['class'=>'form-control','id'=>'datetime'])}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="text-danger" style="font-size: .8rem">Dimension prefarable 300 X 300 px</li>
                                                </ul>
                                            </div>
                                        </div>
