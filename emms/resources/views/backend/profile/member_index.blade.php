                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a  href="{{route('profile.member.create',['user_id'=>Auth::user()->id])}}" title="add new member" class="btn-sm btn-primary" data-card-widge="collapse">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($members as $member)
                                    <tr>
                                        ...
                                        <td><a href="{{route('profileLoan.create',['member_id'=>$member->id])}}" title="Loan" class="btn-sm btn-primary"><i class="fas fa-dollar-sign"></i></a></td>
                                        <td><a href="{{url('profile/savings/create2',$member->id)}}" title="Loan" class="btn-sm btn-primary"><i class="fas fa-sack-dollar"></i></a></td>

                                        <td>
                                            <a href="{{route('profile.member.show',$member->id)}}" title="show details" class="btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                            <a href="{{route('profile.member.edit',$member->id)}}" title="edit" class="btn-sm btn-success "><i class="fas fa-edit"></i></a>
