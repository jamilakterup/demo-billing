                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <div class="card-tools">
                                    <a  href="{{route('instalment.create')}}" title="add new member" class="btn-sm btn-primary" data-card-widge="collapse">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($instalments as $instalment)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('instalment.show',$instalment->id)}}" title="show details" class="btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                            <a href="{{route('instalment.edit',$instalment->id)}}" title="edit" class="btn-sm btn-success "><i class="fas fa-edit"></i></a>
