...
class Profile_loanController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
       if(Auth::user()->id==$request->user_id){
        ...
        $data['loans']=Loan::where('user_id',$request->user_id)->orderBy('id','desc')->get();
            return view('backend.profile.profile_loan.index',$data);
       }
       else{
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.profile.profile_loan.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($savings<$ten_percent){
            \Alert::error('Invalid savings amount', 'Savings should be at least 10% of principal');
...
//        $date = strtotime($start_date);
        ...
        return redirect()->route('profileLoan.index',['user_id'=>$request->user_id]);
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.profile.profile_loan.show',$data);
    }
    ...
    public function edit($id)
    {
        ...
        elseif ($loan_paid==1){
            ...
            return view('backend.profile.profile_loan.edit',$data);
        }
