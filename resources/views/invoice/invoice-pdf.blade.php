...
<body>
    ...
    <div class="container">
        ...
        <p><strong>Subject:</strong> <span
                style="border-bottom:1px solid; padding-bottom:4px; font-family:siliguri">{{ $invoice->subject }}</span>
        </p>
                ...
                @if ($invoice->vat > 0)
                    <tr>
                        <td colspan="6" style="text-align:center">VAT
                            {{ number_format((float) (($invoice->vat * 100) / $invoice->sub_total), 2, '.', ',') }} %
                        </td>
                ...
                @if ($invoice->tax > 0)
                    <tr>
                        <td colspan="6" style="text-align:center">TAX
                            {{ number_format((float) (($invoice->tax * 100) / $invoice->sub_total), 2, '.', ',') }} %
                        </td>
