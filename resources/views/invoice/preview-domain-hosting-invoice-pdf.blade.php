        ...
        <table style="width:100%; border:none">
            <tr>
                <td style="border:none;text-align:left; padding:0">
                    Ref-{{ $invoiceType->invoice_type_short_name }}{{ date('y') }}{{ date('m') }}{{ $invoice['number'] }}
                </td>
        ...
        <table id="details">
            ...
            <tfoot>
                ...
                @if ($cartVat > 0)
                    <tr>
                        <td colspan="6" style="text-align:center">VAT
                            ({{ number_format((float) (($cartVat * 100) / $total), 2, '.', '') }} %)
                        </td>
                ...
                @if ($cartTax > 0)
                    <tr>
                        <td colspan="6" style="text-align:center">TAX
                            ({{ number_format((float) (($cartTax * 100) / $total), 2, '.', '') }} %)
                        </td>
                ...
                <tr>
                    ...
                    <td style="text-align:right">
                        {{ number_format((float) ($total + $cartVat + $cartTax) - $cartDiscount + 1000, 2, '.', ',') }}
                    </td>
                </tr>
