                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn-sm btn-primary" href="{{ route('estimate.create') }}"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary btn-sm"
                                                            href="{{ route('work_order_show', $estimate->id) }}"><i
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                                            <a class="btn btn-outline-primary btn-sm"
                                                                href="{{ route('estimate.download', $estimate->id) }}"><i
                                                                    class="fas fa-download"></i></a>

                                                            <a class="btn btn-outline-primary btn-sm mx-1"
                                                                href="{{ route('estimate.show', $estimate->id) }}"><i
                                                                    class="fas fa-eye"></i></a>

                                                            <a class="btn btn-outline-primary btn-sm mr-1"
                                                                href="{{ route('estimate.edit', $estimate->id) }}"><i
