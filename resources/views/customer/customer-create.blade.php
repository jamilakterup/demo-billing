              ...
              <fieldset class="form-group border p-3">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    {{Form::text('company_email',null,['class'=>'form-control','placeholder'=>'Company
                    email','id'=>'inputCemail4'])}}
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    {{Form::text('company_phone',null,['class'=>'form-control','placeholder'=>'Company
                    phone','id'=>'inputCPhone4'])}}
                    <div class="text-danger">{{$errors->first('company_phone')}}</div>
                  </div>

                  <div class="form-group col-md-6">
                    <label for="inputCweb4">Company website</label>
                    {{Form::text('company_website',null,['class'=>'form-control','placeholder'=>'Company
                    website','id'=>'inputCweb4'])}}
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    {{Form::textarea('company_address',null,['class'=>'form-control','rows'=>'2','placeholder'=>'Company
                    address','id'=>'inputCaddress4'])}}
