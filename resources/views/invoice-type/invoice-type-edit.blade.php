    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Invoice Type</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <div class="col-12 col-sm-12 col-md-12">
                  <div class="card">
                      <div class="card-header">
                          <div class="card-title">Edit Invoice Type</div>
                          <div class="card-tools">
                              <a class="btn-sm btn-primary"  href="{{route('invoiceType.index')}}"><i class="fa fa-caret-left"></i> Back</a>
                          </div>
                      </div>
                      <div class="card-body">
                      {{Form::model($invoicType,['route'=>['invoiceType.update',$invoicType->id],'method'=>'PUT','class'=>'form p-3 border rounded'])}}
                            <div class="form-row">
