@php
    ...
    if (
        $current_route == 'organization' ||
        $current_route == 'invoiceType.index' ||
        $current_route == 'quotationType.index' ||
        $current_route == 'status'
    ) {
        $settingManagement = true;
    }

    if ($current_route == 'organization') {
        $organization = true;
        $settingManagement = true;
    }
    if ($current_route == 'invoiceType.index') {
        $invoiceType = true;
        $settingManagement = true;
    }
    if ($current_route == 'quotationType.index') {
        $quotationType = true;
        $settingManagement = true;
    }
    if ($current_route == 'status') {
        $status = true;
        $settingManagement = true;
    }
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           ...
           with font-awesome or any other icon font library -->
            ...
            <li class="nav-item {{ $settingManagement ? 'menu-open' : '' }}">
                <a href="#" class="nav-link {{ $settingManagement ? 'active' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('organization') }}" class="nav-link {{ $organization ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('invoiceType.index') }}" class="nav-link {{ $invoiceType ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Invoice Type</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('quotationType.index') }}"
                            class="nav-link {{ $quotationType ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Quotation Type</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="/status" class="nav-link {{ $status ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Status</p>
                        </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('designation') }}"
                            class="nav-link {{ $current_route == 'designation' ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Designation</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('employee') }}"
                            class="nav-link {{ $current_route == 'employee' ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>All Employee</p>
                        </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('productType') }}"
                            class="nav-link {{ $current_route == 'productType' ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Type</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('product') }}"
                            class="nav-link {{ $current_route == 'product' ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Product</p>
                        </a>
                    </li>
