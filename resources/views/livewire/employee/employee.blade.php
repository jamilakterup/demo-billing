                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn-sm btn-primary" href="#" wire:click.prevent="addNewEmployee"><i
                                            class="far fa-plus-square"></i> Create Employee</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-outline-primary btn-sm"
                                                        wire:click.prevent="editEmployee({{ $employee }})"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a class="btn btn-outline-danger btn-sm"
                                                        wire:click.prevent="delete({{ $employee->id }})"><i
