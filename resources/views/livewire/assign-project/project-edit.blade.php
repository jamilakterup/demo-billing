        ...
        <div class="border bg-light rounded p-4">
            <div class="form-row">
                ...
                <div class="form-group col">
                    ...
                    <select class="tom" wire:model.defer="state.status" placeholder="Select a state..."
                        autocomplete="off">
            ...
            <div class="form-group col">
                <label for="report" class="form-label">Progress Report</label>
                <textarea wire:model.defer="state.report" class="form-control" id="report" rows="3"></textarea>
            </div>
