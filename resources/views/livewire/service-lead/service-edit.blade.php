<x-livewiremodal-modal>
    <form wire:submit.prevent="Leadupdate">
        ...
        <div class="modal-footer justify-content-end">
            ...
            <button wire:click.prevent="Leadupdate" wire:loading.attr="disabled" class="btn btn-primary">
                <div wire:loading.remove wire:target="Leadupdate">
                    <span><i class="fas fa-save mr-1"></i> Submit</span>
                </div>

                <div wire:loading="Leadupdate" wire:target="Leadupdate">
