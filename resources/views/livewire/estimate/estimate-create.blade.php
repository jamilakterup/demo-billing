    ...
    <div class="border bg-light rounded p-4">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="tom-select form-control @error('quotation_type_id') is-invalid @enderror"
                    wire:model.defer="state.quotation_type_id" wire:change="quotationType($event.target.value)">
                    <option value="">--Please Select--</option>
                    @foreach ($quotationTypes as $quotationType)
                        <option value="{{ $quotationType['id'] }}" @if (isset($state['quotation_type_id']) && $state['quotation_type_id'] == $quotationType['id']) selected @endif>
                            {{ $quotationType['quotation_type_name'] }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="date" wire:model.defer="state.estimate_date" class="datepicker form-control"
                    id="" aria-describedby="emailHelp" placeholder="Estimate Date">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" wire:model.defer="state.expiry_date" class="datepicker form-control"
                    id="" aria-describedby="emailHelp" placeholder="Expiry Date">
    ...
    <div class="row bg-white pt-4">
        ...
        <div class="col-md-5">
            <div class="position-relative bg-light border rounded p-4">
                ...
                @else
                    @if ($errors->has('quotation_type_id'))
                        <div class="text-danger text-sm"><small>{{ $errors->first('quotation_type_id') }}</small>
                        </div>
                    @endif
                    <div class="row g-1 mb-3">
                        ...
                        <div class="col-sm-8">
                            <select class="tom-select form-control @error('customer_id') is-invalid @enderror"
                                ...
                                @foreach ($products as $key => $value)
                                    <option value="{{ $key }}"
                                        @if (isset($addpro['product_id']) && $addpro['product_id'] == $key) selected @endif>{{ $value }}</option>
                                @endforeach
                            </select>
        ...
        <div class="p-3">
            ...
            <textarea style="width:600px" class="form-control @error('note') is-invalid @enderror" wire:model.defer="state.note"
                id="note"></textarea>
            @if ($errors->has('note'))
