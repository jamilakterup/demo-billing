            ...
            <div class="form-group col-md-4">
                ...
                <select class="tom-select @error('customer_id') is-invalid @enderror"
                    ...
                    @foreach ($customers as $key => $value)
                        <option value="{{ $key }}" @if ($key == $state['customer_id']) selected @endif>
                            {{ $value }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <select class="tom-select form-control @error('quotation_type_id') is-invalid @enderror"
                    ...
                    @foreach ($estimateTypes as $estimateType)
                        <option value="{{ $estimateType['id'] }}" @if (isset($state['quotation_type_id']) && $state['quotation_type_id'] == $estimateType['id']) selected @endif>
                        ...
                        @foreach (\Cart::getContent()->sortBy('id') as $cart)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-outline-danger btn-sm del" type="edit"
                        ...
                        <div class="col-sm-8">
                            <select class="tom-select form-control @error('customer_id') is-invalid @enderror"
                                ...
                                @foreach ($products as $key => $value)
                                    <option value="{{ $key }}"
                                        @if (isset($addpro['product_id']) && $addpro['product_id'] == $key) selected @endif>{{ $value }}
                                    </option>
                                @endforeach
                            </select>
