    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">CP Lead</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">CP-lead</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools d-flex">
                                    <button class="btn btn-primary btn-sm" style="width:110px" type="button"
                                        onclick='_openModal("Upload CP Lead", "cp-lead.cp-upload","[]","lg")'>
                                        <i class="fa fa-plus"></i> Upload Lead</button>

                                    <button class="btn btn-primary btn-sm mx-1" style="width:150px" type="button"
                                        onclick='_openModal("Add New Lead", "cp-lead.cp-new","[]","lg")'>
                                        <i class="fa fa-plus"></i> Add CP Lead</button>

                                    <button type="button" style="width:40px"
                                        class="btn btn-primary position-relative mr-2"
                                        onclick='_openModal("Followup Notification", "cp-lead.cp-notification",[], "xl")'>
