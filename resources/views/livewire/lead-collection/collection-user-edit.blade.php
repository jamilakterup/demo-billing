<x-livewiremodal-modal>
    <form wire:submit.prevent="LeadUserUpdate">
        <div class="border bg-light rounded p-4">
            ...
            <div class="modal-footer justify-content-end">
                ...
                <button wire:click.prevent="LeadUserUpdate" wire:loading.attr="disabled" class="btn btn-primary">
                    <div wire:loading.remove wire:target="LeadUserUpdate">
                        <span><i class="fas fa-save mr-1"></i> Submit</span>
                    </div>

                    <div wire:loading="LeadUserUpdate" wire:target="LeadUserUpdate">
