<x-livewiremodal-modal>
    <form wire:submit.prevent="invoiceStore">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    @if ($errors->has('expected_payment_date'))
                        <div class="text-danger text-sm"><small>{{ $errors->first('expected_payment_date') }}</small>
                        </div>
                    @endif
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control @error('vat_text_visibility') is-invalid @enderror"
                        ...
                        <option value="">-Please select-</option>
                        <option value="All prices are including VAT & TAX.">All prices are including VAT & TAX.
                        </option>
                        <option value="All prices are excluding VAT & TAX.">All prices are excluding VAT & TAX.
                        </option>
                        <option value="VAT & TAX. Paid by">VAT & TAX. Paid by</option>
                        <option value="None">None</option>
                    </select>
                    @if ($errors->has('vat_text_visibility'))
                        <div class="text-danger text-sm"><small>{{ $errors->first('vat_text_visibility') }}</small>
                        </div>
                    @endif
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($errors->has('auto_seal_signature'))
                        <div class="text-danger text-sm"><small>{{ $errors->first('auto_seal_signature') }}</small>
                        </div>
                    @endif
                </div>
            </div>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-primary btn-sm"
                                            wire:click.prevent="productEdit({{ $cart->id }})"><i
                                                class="fas fa-edit"></i></a>
                                        <a class="btn btn-outline-danger btn-sm del" type="new"
                                            data="{{ $cart->id }}"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input wire:model.defer="discount" type="text"
                                        class="form-control discount key_up">
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="due" class="form-control due" disabled />
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
                ...
                <div class="position-relative border bg-light rounded p-4">
                    ...
                    @if ($isNewProduct)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if ($errors->has('product_type_id'))
                                    <div class="text-danger text-sm">
                                        <small>{{ $errors->first('product_type_id') }}</small>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if ($errors->has('product_quantity'))
                                    <div class="text-danger text-sm">
                                        <small>{{ $errors->first('product_quantity') }}</small>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-sm-8">
                                <button type="button" wire:click.prevent="addNewProduct"
                                ...
                                <button type="button" wire:click.prevent="newProductToggle"
                    ...
                    @else
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if ($errors->has('product_id'))
                                    <div class="text-danger text-sm"><small>{{ $errors->first('product_id') }}</small>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row g-1 mb-3">
                            <label class="col-sm-4 col-form-label">Vat & Tax <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <select wire:model="addpro.vat_tax"
                                    class="form-control check include-vat-tax tom-select">
                                    <option value="">-Please select-</option>
                                    <option value="false">No</option>
                                    <option value="true">Yes</option>
                                </select>
                                @if ($errors->has('vat_tax'))
                                    <div class="text-danger text-sm"><small>{{ $errors->first('vat_tax') }}</small>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="col-8 d-flex">
                                <input type="text" wire:model="addpro.vatTaxVal"
                                    class="form-control w-50 vatTaxVal key_up me-5" placeholder="Enter Vat Tax">
                        ...
                        <div class="row g-1 mb-3">
                            ...
                            <div class="col-sm-8">
                                @if ($isEdit)
                                    <button type="button" wire:click.prevent="updateProduct"
                                        wire:loading.attr="disabled" class="btn btn-primary">
                                ...
                                @else
                                    <button type="button" wire:click.prevent="addProduct"
                                        wire:loading.attr="disabled" class="btn btn-primary">
        ...
        <div class="modal-footer justify-content-center">
            @if (!Cart::isEmpty())
                <button type="button" wire:click.prevent="invoicePreview" wire:loading.attr="disabled"
                    class="btn btn-info">
                ...
                <button wire:click.prevent="invoiceStore" wire:loading.attr="disabled" class="btn btn-primary">
